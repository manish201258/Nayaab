...
const { updateLastLogin } = require("../adminController/userController");
...
async function userLogin(req, res) {
  try {
    ...
    // For regular user login, we don't want admins to use this endpoint
    if (user.isAdmin) {
...
async function register(req, res) {
  try {
    ...
    user = new User({
      ...
      email,
      password,
      isAdmin: false // Ensure new registrations are always regular users
    });
...
module.exports = { login, userLogin, register };
